    ...
    <div className="Trip">
      ...
      <div className="tripcard">
        ...
        <TripData
          ...
          text="Malaysia is a Southeast Asian country occupying parts of the Malay Penisula and the island of Borneo. It's known for its beaches, rainforests and mix of Malay, Chinese, Indian and European cultural influences."
        />
        <TripData
          image={Trip3}
